...
function NutritionTable(props: NutritionTableProps) {
  const mergeNutritionInfo = (
    completeNutriValues: NutritionValue[],
    itemValues: NutritionValue[]
  ) => {
    return completeNutriValues.map((completeNutriValue) => {
      const itemValue =
        itemValues[
          completeNutriValues.findIndex(
            (value) => value.name === completeNutriValue.name
          )
        ];
  ...
  const mergedNutritionInfo = mergeNutritionInfo(
    NutritionValuesRDI,
    NutritionValuesDummy
  );
  ...
  return (
    <table>
      ...
      <tbody>
        {mergedNutritionInfo.map((nutritionValue, i) => {
          return (
            <React.Fragment key={i}>
              <tr>
                <td>{nutritionValue.name}</td>
                <td>{nutritionValue.value ? nutritionValue.value : "---"}</td>
                <td>
